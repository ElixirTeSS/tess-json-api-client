...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContentProviderAttributes', 'model/ResourceObject'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContentProviderAttributes'), require('./ResourceObject'));
  } else {
    // Browser globals (root is window)
    if (!root.TessJsonApi) {
      root.TessJsonApi = {};
    }
    root.TessJsonApi.ContentProviderResource = factory(root.TessJsonApi.ApiClient, root.TessJsonApi.ContentProviderAttributes, root.TessJsonApi.ResourceObject);
  }
}(this, function(ApiClient, ContentProviderAttributes, ResourceObject) {
  'use strict';
