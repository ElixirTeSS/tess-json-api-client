...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MaterialAttributes', 'model/ResourceObject'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MaterialAttributes'), require('./ResourceObject'));
  } else {
    // Browser globals (root is window)
    if (!root.TessJsonApi) {
      root.TessJsonApi = {};
    }
    root.TessJsonApi.MaterialResource = factory(root.TessJsonApi.ApiClient, root.TessJsonApi.MaterialAttributes, root.TessJsonApi.ResourceObject);
  }
}(this, function(ApiClient, MaterialAttributes, ResourceObject) {
  'use strict';
