...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResourceObject', 'model/WorkflowAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResourceObject'), require('./WorkflowAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.TessJsonApi) {
      root.TessJsonApi = {};
    }
    root.TessJsonApi.WorkflowResource = factory(root.TessJsonApi.ApiClient, root.TessJsonApi.ResourceObject, root.TessJsonApi.WorkflowAttributes);
  }
}(this, function(ApiClient, ResourceObject, WorkflowAttributes) {
  'use strict';
