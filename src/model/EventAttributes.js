...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EventAttributesReport', 'model/ExternalResource', 'model/ScientificTopic'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EventAttributesReport'), require('./ExternalResource'), require('./ScientificTopic'));
  } else {
    // Browser globals (root is window)
    if (!root.TessJsonApi) {
      root.TessJsonApi = {};
    }
    root.TessJsonApi.EventAttributes = factory(root.TessJsonApi.ApiClient, root.TessJsonApi.EventAttributesReport, root.TessJsonApi.ExternalResource, root.TessJsonApi.ScientificTopic);
  }
}(this, function(ApiClient, EventAttributesReport, ExternalResource, ScientificTopic) {
  'use strict';
