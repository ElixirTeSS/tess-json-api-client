...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TessJsonApi.EventAttributes = factory(root.TessJsonApi.ApiClient, root.TessJsonApi.ExternalResource, root.TessJsonApi.OntologyTerm);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('event-types'))
        obj.eventTypes = ApiClient.convertToType(data['event-types'], ['String']);
      ...
      if (data.hasOwnProperty('host-institutions'))
        obj.hostInstitutions = ApiClient.convertToType(data['host-institutions'], ['String']);
   ...
   * @member {Array.<String>} hostInstitutions
   */
  exports.prototype.hostInstitutions = undefined;
