...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContentProvider', 'model/ContentProviderAttributes', 'model/ContentProviderCollection', 'model/ContentProviderResource', 'model/Event', 'model/EventAttributes', 'model/EventCollection', 'model/EventResource', 'model/ExternalResource', 'model/Facet', 'model/FacetedCollection', 'model/JsonApiResponse', 'model/Links', 'model/Material', 'model/MaterialAttributes', 'model/MaterialCollection', 'model/MaterialResource', 'model/MultiRelationshipObject', 'model/OntologyTerm', 'model/PaginationLinks', 'model/ResourceIdentifierObject', 'model/ResourceObject', 'model/SingleRelationshipObject', 'model/User', 'model/UserAttributes', 'model/UserCollection', 'model/UserResource', 'model/Workflow', 'model/WorkflowAttributes', 'model/WorkflowCollection', 'model/WorkflowResource', 'api/ContentProvidersApi', 'api/EventsApi', 'api/MaterialsApi', 'api/UsersApi', 'api/WorkflowsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ContentProvider'), require('./model/ContentProviderAttributes'), require('./model/ContentProviderCollection'), require('./model/ContentProviderResource'), require('./model/Event'), require('./model/EventAttributes'), require('./model/EventCollection'), require('./model/EventResource'), require('./model/ExternalResource'), require('./model/Facet'), require('./model/FacetedCollection'), require('./model/JsonApiResponse'), require('./model/Links'), require('./model/Material'), require('./model/MaterialAttributes'), require('./model/MaterialCollection'), require('./model/MaterialResource'), require('./model/MultiRelationshipObject'), require('./model/OntologyTerm'), require('./model/PaginationLinks'), require('./model/ResourceIdentifierObject'), require('./model/ResourceObject'), require('./model/SingleRelationshipObject'), require('./model/User'), require('./model/UserAttributes'), require('./model/UserCollection'), require('./model/UserResource'), require('./model/Workflow'), require('./model/WorkflowAttributes'), require('./model/WorkflowCollection'), require('./model/WorkflowResource'), require('./api/ContentProvidersApi'), require('./api/EventsApi'), require('./api/MaterialsApi'), require('./api/UsersApi'), require('./api/WorkflowsApi'));
  }
}(function(ApiClient, ContentProvider, ContentProviderAttributes, ContentProviderCollection, ContentProviderResource, Event, EventAttributes, EventCollection, EventResource, ExternalResource, Facet, FacetedCollection, JsonApiResponse, Links, Material, MaterialAttributes, MaterialCollection, MaterialResource, MultiRelationshipObject, OntologyTerm, PaginationLinks, ResourceIdentifierObject, ResourceObject, SingleRelationshipObject, User, UserAttributes, UserCollection, UserResource, Workflow, WorkflowAttributes, WorkflowCollection, WorkflowResource, ContentProvidersApi, EventsApi, MaterialsApi, UsersApi, WorkflowsApi) {
  'use strict';
