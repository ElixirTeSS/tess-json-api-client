  ...
  describe('(package)', function() {
    describe('MaterialAttributes', function() {
      ...
      it('should create an instance of MaterialAttributes', function() {
        // TODO: update the code to test MaterialAttributes
      ...
      it('should have the property remoteUpdatedDate (base name: "remote-updated-date")', function() {
        // TODO: update the code to test the property remoteUpdatedDate
        expect(instance).to.have.property('remoteUpdatedDate');
        // expect(instance.remoteUpdatedDate).to.be(expectedValueLiteral);
      });

      it('should have the property remoteCreatedDate (base name: "remote-created-date")', function() {
        // TODO: update the code to test the property remoteCreatedDate
        expect(instance).to.have.property('remoteCreatedDate');
        // expect(instance.remoteCreatedDate).to.be(expectedValueLiteral);
      });
