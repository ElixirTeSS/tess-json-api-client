...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TessJsonApi.NodeCollection();
  });
  ...
  describe('NodeCollection', function() {
    it('should create an instance of NodeCollection', function() {
      // uncomment below and update the code to test NodeCollection
      //var instance = new TessJsonApi.NodeCollection();
      //expect(instance).to.be.a(TessJsonApi.NodeCollection);
    });
