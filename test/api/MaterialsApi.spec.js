    ...
    describe('MaterialsApi', function() {
      describe('materialsGet', function() {
        it('should call materialsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for materialsGet call and complete the assertions
          /*
          var opts = {};
          opts.q = "q_example";
          opts.pageNumber = 1;
          ...
          opts.resourceType = ["resourceType_example"];

          instance.materialsGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(TessJsonApi.MaterialCollection);
            ...
            expect(data.jsonapi).to.be();
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(TessJsonApi.MaterialResource);
                ...
                expect(data.meta).to.be.a(Object);
                expect(data.meta).to.be();
                expect(data.attributes).to.be.a(TessJsonApi.MaterialAttributes);
                  ...
                  expect(data.attributes.remoteUpdatedDate).to.be.a(Date);
                  expect(data.attributes.remoteUpdatedDate).to.be(new Date());
                  expect(data.attributes.remoteCreatedDate).to.be.a(Date);
                  expect(data.attributes.remoteCreatedDate).to.be(new Date());
      ...
      describe('materialsSlugGet', function() {
        it('should call materialsSlugGet successfully', function(done) {
          // TODO: uncomment, update parameter values for materialsSlugGet call and complete the assertions
          /*
          var slug = "slug_example";

          instance.materialsSlugGet(slug, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(TessJsonApi.Material);
            expect(data.errors).to.be.a(Object);
            expect(data.errors).to.be();
            expect(data.meta).to.be.a(Object);
            expect(data.meta).to.be();
            ...
            expect(data.jsonapi).to.be.a(Object);
            expect(data.jsonapi).to.be();
            expect(data.data).to.be.a(TessJsonApi.MaterialResource);
              ...
              expect(data.data.attributes).to.be.a(TessJsonApi.MaterialAttributes);
                ...
                expect(data.data.attributes.remoteUpdatedDate).to.be.a(Date);
                expect(data.data.attributes.remoteUpdatedDate).to.be(new Date());
                expect(data.data.attributes.remoteCreatedDate).to.be.a(Date);
                expect(data.data.attributes.remoteCreatedDate).to.be(new Date());
